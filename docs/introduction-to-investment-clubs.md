...
Fish Network brings a new sustainable model to community driven early stage investing, while providing the necessary services required to scale seed stage startups.

Our club structure fosters a transparent, community-driven model that prioritizes liquidity, innovation, and diversification. The community votes to invest in high-potential seed stage startups, splitting the upside between organizers and members, and rewarding contributions through a decentralized investment committee.
