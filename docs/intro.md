...
## Fish Network Liquidity Transfer
...
#### Option A — "80/20 Micro‑Fund" (front‑loaded admin)
...
* **10%** to school treasury for ops.

### Fees & Liquidity

* **Organizer fee:** Front‑loaded administrative fee (covers BD, diligence, coordination).
