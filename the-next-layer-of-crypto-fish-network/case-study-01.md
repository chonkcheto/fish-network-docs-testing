...
* You and five friends want to pool $50,000 to invest in early-stage startups.<br>
* In fiat, you’d open a bank account, draft an LLC operating agreement, hire a lawyer, and manually enforce the rules.

<figure><img src="../.gitbook/assets/crypto.avif" alt=""><figcaption></figcaption></figure>



* ### In a smart contract world:<br>
...
2. You input rules: “Minimum contribution = $5k. Votes weighted equally. Majority rules for disbursement. Unspent funds can be redeemed after 12 months.”\
   <br>
3. The smart contract governs the pool automatically — funds can only move when the vote condition is met. No lawyer or escrow agent needed.<br>
